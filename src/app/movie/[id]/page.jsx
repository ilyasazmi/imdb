    ...
    return (
        <div className="w-full">
            <div className="p-4 md:pt-8 flex flex-col md:flex-row items-center content-center max-w-6xl mx-auto md:space-x-6">
                <Image className="rounded-lg" width={500} height={300} src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.poster_path}`} alt="movie poster" style={{ maxWidth: "100%", height: "auto" }} placeholder="blur" blurDataURL="spinner.svg" />
                <div className="p-2">
